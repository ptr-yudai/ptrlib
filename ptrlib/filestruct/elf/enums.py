"""This package provides constants related to ELF.
"""
...
ENUM_D_TAG_COMMON = dict(
    ...
    DT_RUNPATH=29,
    DT_FLAGS=30,
    DT_ENCODING=31, # TODO: Check if this is correct
    DT_PREINIT_ARRAY=32,
...
for _, v in ENUMMAP_EXTRA_D_TAG_MACHINE.items():
    ENUM_D_TAG.update(v)
...
__all__ = [
    'ENUM_EI_CLASS', 'ENUM_EI_DATA', 'ENUM_E_VERSION', 'ENUM_EI_OSABI',
    'ENUM_E_TYPE', 'ENUM_E_MACHINE', 'ENUM_SH_TYPE_BASE', 'ENUM_ELFCOMPRESS_TYPE',
    'ENUM_P_TYPE_BASE', 'ENUM_P_FLAGS', 'ENUM_ST_INFO_BIND', 'ENUM_ST_INFO_TYPE',
    'ENUM_ST_VISIBILITY', 'ENUM_ST_SHNDX', 'ENUM_D_TAG_COMMON', 'ENUM_D_TAG_SOLARIS',
    'ENUM_D_TAG_MIPS', 'ENUM_D_TAG', 'ENUM_DT_FLAGS', 'ENUM_DT_FLAGS_1',
    'ENUM_RELOC_TYPE_MIPS', 'ENUM_RELOC_TYPE_i386', 'ENUM_RELOC_TYPE_x64',
    'ENUM_SUNW_SYMINFO_BOUNDTO', 'ENUM_VERSYM', 'ENUM_NOTE_N_TYPE',
    'ENUM_CORE_NOTE_N_TYPE', 'ENUM_NOTE_ABI_TAG_OS',
    'ENUM_RELOC_TYPE_ARM', 'ENUM_RELOC_TYPE_AARCH64', 'ENUM_ATTR_TAG_ARM',
    'ENUM_SH_TYPE_AMD64', 'ENUM_SH_TYPE_ARM', 'ENUM_SH_TYPE_MIPS', 'ENUM_P_TYPE_ARM',
    'ENUM_P_TYPE_AARCH64', 'ENUM_P_TYPE_MIPS', 'ENUMMAP_EXTRA_D_TAG_MACHINE'
]
